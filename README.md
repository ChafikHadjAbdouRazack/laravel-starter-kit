...
Last but not least, the server component of API Platform integrates with the [Laravel](https://laravel.com) framework,
...
* Enjoy the popular [Eloquent ORM](https://laravel.com/docs/eloquent) (used by default, but fully optional:
...
[Then, follow our "Getting Started" guide](https://api-platform.com/docs/laravel/).
